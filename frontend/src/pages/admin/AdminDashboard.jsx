  ...
  return (
    <div className="admin-page">
      ...
      <div style={{ marginTop: 12, padding: '14px 18px', background: 'var(--gray-50)', borderRadius: 'var(--radius-md)', border: '1px solid var(--gray-200)', fontSize: '0.8rem', color: 'var(--gray-500)' }}>
        🔒 <strong>Admin Access:</strong> <code style={{ background: 'var(--gray-200)', padding: '2px 6px', borderRadius: 4, fontFamily: 'monospace' }}>http://localhost:5173/admin/login/307802</code> — Keep confidential.
      </div>
    </div>
  );
}
