...
const SECTIONS = [
  ...
  { key: 'historical_development', label: 'Historical Development of AANNHS', Icon: IconLayers },
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="section-subtitle">
            The story, identity, and community that define Andres A. Nocon National High School.
          </p>
