...
export default function ContactPage() {
  ...
  const contactDetails = [
    { Icon: IconMapPin, label: 'Address', val: info?.address || 'Caballero St., Buenavista II, City of General Trias, Cavite' },
    { Icon: IconPhone, label: 'Phone', val: info?.landline || '(046) 432-0252' },
    { Icon: IconMail, label: 'Email', val: info?.email || '307802@deped.gov.ph' },
    { Icon: IconClock, label: 'Office Hours', val: info?.office_hours || '6:00 AM – 6:00 PM, Monday–Saturday' },
  ];
    ...
    <div>
      <div className="page-header">
        <div className="container">
          <h1>Contact Us</h1>
          <p>Reach out to Andres A. Nocon National High School</p>
        </div>
      </div>
          ...
          <div className="contact-grid">
            ...
            <div>
              ...
              <div style={{ marginTop: 24, borderRadius: 'var(--radius-lg)', overflow: 'hidden', border: '1px solid var(--gray-200)' }}>
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3868.5!2d120.8796!3d14.3910!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sAndres+A.+Nocon+National+High+School!5e0!3m2!1sen!2sph!4v1700000000"
                  width="100%" height="250" style={{ border: 0, display: 'block' }}
                  allowFullScreen loading="lazy" title="AANNHS Location Map"
