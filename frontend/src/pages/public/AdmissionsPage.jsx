...
const CHARTER_INFO = {
  office: 'Andres A. Nocon National High School',
...
const PROCESS_STEPS = [
  {
    ...
    actions: [
      ...
      {
        action: 'Endorse list of enrollees to Records/Registrar of Incoming Grade 7 / Transferees / SNED.',
        fee: 'None',
        time: '5 minutes',
        responsible: 'Registrar / Teacher-in-Charge / Adviser',
      },
...
export default function AdmissionsPage() {
  ...
  const stats = [
    ...
    { Icon: IconBook, label: 'Grade Levels', value: 'Junior High School: Grade 7 to Grade 10' },
    ...
    <div>
      <div className="page-header">
        <div className="container">
          ...
          <p>Everything you need to know about enrolling at AANNHS</p>
        </div>
      </div>
