...
const GRADE_LEVELS = ['Grade 7', 'Grade 8', 'Grade 9', 'Grade 10', 'Non-Teaching'];
      ...
      <section className="section">
        <div className="container">
          ...
          {loading ? (
            ...
            <div className="card" style={{ padding: 0, overflow: 'hidden', marginBottom: 32 }}>
              <img
                ...
                alt="AANNHS Organizational Chart"
          ...
          <p style={{ color: 'var(--gray-500)', fontSize: '0.88rem', marginBottom: 28 }}>
            Teaching and non-teaching personnel of AANNHS, grouped by grade level. Click a profile to view more.
          </p>
